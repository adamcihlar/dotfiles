...
map <Leader>;, :SlimuxREPLSendLine<CR>j
...
"Plug 'ludovicchabant/vim-gutentags' "uncomment, if the error is not solved
...
" Insert line without leaving the normal mode
...
" Insert breakpoint on new line
nnoremap <Leader>di oimport ipdb; ipdb.set_trace();<esc>==
